...
Đồ án môn **Lập trình Nâng cao** - phiên bản Giao diện Desktop (PyQt6) đi kèm
phiên bản Web (Django) ở thư mục `du_an_cua_hang_sach/`.
...
## 4. 5 TÍNH NĂNG MỞ RỘNG (ĐIỂM CỘNG)
...
| **Tính năng mở rộng** | ✅ Đủ 5/5 (Undo/Redo, Giỏ hàng, Thống kê, Tìm kiếm, 5 loại) |
