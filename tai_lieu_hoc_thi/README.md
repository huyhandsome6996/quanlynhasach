...
| Folder | Người | Chủ đề ôn thi |
|--------|-------|---------------|
| `01_ho_quang_huy/` | Huy | Danh sách liên kết đôi + Merge Sort + PyQt6 (cực kỳ chi tiết: từng dòng code) + Undo/Redo + Thống kê |
| `02_bui_gia_ngo/`  | Ngọ | Stack (LIFO) + SQLite CRUD + Phân quyền Admin/NV + Test case |
| `03_phan_anh_tu/`  | Tú  | OOP (Kế thừa + Đa hình) + Queue (FIFO) Giỏ hàng + PyQt6 Dialogs |
...
5. **Mở file Python tương ứng** trong `do_an_pyqt6/` để đối chiếu
